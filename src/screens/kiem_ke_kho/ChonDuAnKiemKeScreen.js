...
class DuAnComponent extends Component {
    ...
    onChangeDuAn = (value) => {
        // console.log("onChangeDuAnonChangeDuAn", value);
...
class ChonDuAnKiemKeScreen extends Component {
    constructor(props) {
        super(props);
        this.state = ({
            dataDuAn: []
    ...
    _makeRemoteRequest = (cb) => {
       if(this.isSubmit) return;
        this.isSubmit=true;
        this.props.kiemkekhoAction.getListProjects(this.dataFilter, (error, data) => {
            ...
            <View style={styles.container}>
                ...
                <CListView
                    ...
                    renderItem={(item, index) => {
                        ...
                        return(
                            <DuAnComponent value={item} key={index} isChecked={isChecked} navigation={this.props.navigation}/>
                        )
                    }}
