...
import MenuScreen from "../menu_screen/MenuScreen";
import MenuMSSScreen from "../menu_screen/MenuMSSScreen";
import NotificationScreen from "../notification_screen/NotificationScreen";
...
class HomeScreen extends Component {
    ...
    logOut =  () => {
        Config.alertMess({message:Config.lang('PM_Ban_co_muon_dang_xuat_tai_khoan')},'YES_NO',()=> {
            ...
            // this.props.mainActions.getToken('diginet',async (error, data1)=>{
    ...
    render() {
        ...
        let dataTab = [
            ...
            },
            {
                ...
                />,
                icon:require('../../assets/images/tab-bar/notification.png'),
                iconActive:require('../../assets/images/tab-bar/notification-active.png'),
                percent: 25,
                badge:true
            },
            {
