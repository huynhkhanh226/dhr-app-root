...
class ChoXacNhanTaiSanDaNhanScreen extends Component {
    constructor(props) {
        super(props);
    ...
    _makeRemoteRequest = (cb) => {
        ...
        this.props.xntsdnAction.getListWaitingReceived(this.dataFilter, (error, data) => {
    ...
    render() {
        ...
        const {getListWaitingReceived} = this.props;
        const getList = getListWaitingReceived && getListWaitingReceived.rows ? getListWaitingReceived.rows : [];
...
export default connect(state => ({
        getListWaitingReceived: state.xntsdn.getListWaitingReceived
    }), (dispatch) => ({
        navigationActions: bindActionCreators(navigationActions, dispatch),
        xntsdnAction: bindActionCreators(xntsdnAction, dispatch),
    })
)(ChoXacNhanTaiSanDaNhanScreen);
