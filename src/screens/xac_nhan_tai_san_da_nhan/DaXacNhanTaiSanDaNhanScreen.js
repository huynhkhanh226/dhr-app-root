...
class DaXacNhanTaiSanDaNhanScreen extends Component {
    ...
    _makeRemoteRequest = (cb) => {
        ...
        this.props.xntsdnAction.getListConfirmReceived(this.dataFilter, (error, data) => {
    ...
    render() {
        ...
        const {getListConfirmReceived} = this.props;
        const getList = getListConfirmReceived && getListConfirmReceived.rows ? getListConfirmReceived.rows : [];
        return (
...
export default connect(state => ({
        getListConfirmReceived: state.xntsdn.getListConfirmReceived
    }), (dispatch) => ({
        navigationActions: bindActionCreators(navigationActions, dispatch),
        xntsdnAction: bindActionCreators(xntsdnAction, dispatch),
    })
)(DaXacNhanTaiSanDaNhanScreen);
