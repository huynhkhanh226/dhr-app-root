...
import DanhSachDeXuatComponent from "./DanhSachXNTSDaNhanComponent";
...
class TatCaXacNhanTaiSanDaNhanScreen extends Component {
    constructor(props) {
        super(props);
    ...
    _makeRemoteRequest = (cb) => {
        ...
        this.props.xntsdnAction.getListAllReceived(this.dataFilter, (error, data) => {
    ...
    render() {
        ...
        const {getListAllReceived} = this.props;
        const getList = getListAllReceived && getListAllReceived.rows ? getListAllReceived.rows : [];
        return (
...
export default connect(state => ({
        getListAllReceived: state.xntsdn.getListAllReceived
    }), (dispatch) => ({
        navigationActions: bindActionCreators(navigationActions, dispatch),
        xntsdnAction: bindActionCreators(xntsdnAction, dispatch),
    })
)(TatCaXacNhanTaiSanDaNhanScreen);
