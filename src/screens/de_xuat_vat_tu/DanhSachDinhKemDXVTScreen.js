...
class DanhSachDinhKemDXVTScreen extends Component {
    constructor(props) {
        super(props);
        this.state = ({
        });
    ...
    render() {
        ...
        const dataAttach = getDetailPropose && getDetailPropose.attachment && getDetailPropose.attachment.length>0 ? getDetailPropose.attachment : [];
        return (
