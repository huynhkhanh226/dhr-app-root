...
class ChoXacNhanScreen extends Component {
    constructor(props) {
        super(props);
    ...
    _makeRemoteRequest = (cb) => {
        ...
        this.props.xnnktAction.getListWaitingWH(this.dataFilter, (error, data) => {
    ...
    render() {
        ...
        const {getListWaitingWH} = this.props;
        const getList = getListWaitingWH && getListWaitingWH.rows ? getListWaitingWH.rows : [];
...
export default connect(state => ({
        getListWaitingWH: state.xnnk.getListWaitingWH
    }), (dispatch) => ({
