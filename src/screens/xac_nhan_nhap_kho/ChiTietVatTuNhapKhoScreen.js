...
class ChiTietVatTuNhapKhoScreen extends Component {
    constructor(props) {
        super(props);
        this.state = ({
            isSubmit: false,
    ...
    onLink = (name) => {
        ...
        const VoucherID = dataInventory && dataInventory.infoGeneral && dataInventory.infoGeneral.VoucherID ? dataInventory.infoGeneral.VoucherID : '';
    ...
    changeValue = (number, idx) => {
        ...
        this.setState({
            ...
            if (this.props.onChange) this.props.onChange(this.dataInventoryTemp);
        });
    };
