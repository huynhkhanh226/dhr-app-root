...
class DanhSachComponent extends Component {
    ...
    render() {
        ...
        const isChecked = value && value.StatusID && value.StatusID === "002" ? 0 : 1;
        return (
            <View style={{
                borderBottomWidth: 1,
                ...
                >
                    <View style={{height: '100%', width: !isChecked ? '90%' : '100%'}}>
                        ...
                        <View style={styles.componentViewContent}>
                            <Text
                                style={styles.componentTextContent}>{Config.lang("PM_Nguoi_nhap")}</Text>
                            <View style={styles.viewDashContent}>
                            </View>
                            <Text style={styles.componentTextContentRight}
                                  numberOfLines={1}>
                        ...
                        <View style={styles.componentViewContent}>
                            <Text
                                style={styles.componentTextContent}>{Config.lang("PM_Ngay_nhap")}</Text>
                            <View style={styles.viewDashContent}>
                            </View>
                            <Text style={styles.componentTextContentRight} numberOfLines={1}>
                                {value && value.OVoucherDate ? moment(value.OVoucherDate).format('DD/MM/YYYY') : null}
                            </Text>
                        </View>
                        <View style={styles.componentViewContent}>
                            <Text
