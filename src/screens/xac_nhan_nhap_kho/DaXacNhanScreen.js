...
class DaXacNhanScreen extends Component {
    ...
    _makeRemoteRequest = (cb) => {
        ...
        this.props.xnnktAction.getListConfirmWH(this.dataFilter, (error, data) => {
    ...
    render() {
        ...
        const {getListConfirmWH} = this.props;
        const getList = getListConfirmWH && getListConfirmWH.rows ? getListConfirmWH.rows : [];
        return (
...
export default connect(state => ({
        getListConfirmWH: state.xnnk.getListConfirmWH
    }), (dispatch) => ({
