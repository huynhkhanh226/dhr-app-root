...
class DuyetXacNhanChoMuonTSScreen extends Component {
    ...
    getCaption = () =>{
        ...
        this.props.xncmtsAction.getCaptionBorrow({VoucherID: this.props.navigation.state.params.voucherID}, (error, data) => {
            if (error) {
    ...
    onApproval = () => {
        ...
        const param = {
            OBatchID: valueParam && valueParam.OBatchID ? valueParam.OBatchID : '',
        ...
        this.props.xncmtsAction.getNewIDConfirmBorrow({FormID: 'A54F2562'}, (error, data) => {
            if (error) {
                Config.alertMess({code: '', message: error.message});
                ...
                if (imgAva && imgAva.length) {
                            ...
                            if(dataAttach.length>0){
                                ...
                                this.props.mainActions.attachPropose({params: JSON.stringify(params)}, (err1, data1) => { //save attachment to Propose
                                    if (data1) {
                                        ...
                                        this.props.xncmtsAction.AppRVoucherBorrow(param, (errApp, dataApp) => {
                                            if (errApp) {
                                                ...
                                                this.props.xncmtsAction.getDetailConfirmBorrow({VoucherID: data.VoucherID});
                    ...
                    param.VoucherID = data.VoucherID;
                    this.props.xncmtsAction.AppRVoucherBorrow(param, (errApp1, dataApp1) => {
                        if (errApp1) {
    ...
    onSaveReject = () => {
        ...
        this.props.xncmtsAction.getDetailConfirmBorrow({VoucherID: this.props.navigation.state.params.voucherID});
    ...
    render() {
        const {imgAva, flag, isLoading, isReject, Caption, VoucherNo, loading} = this.state;
        return (
            <View style={styles.container}>
                <Header navigation={this.props.navigation}
                        ...
                        showBack={true}
                        headerName={Config.lang('PM_Xac_nhan_cho_muon')}
                        colorBtnRight={Config.gStyle.color_def1}
                />
                <CShapeHeader title={Caption}
                              value={VoucherNo}
                              isLoading={loading}
                />
