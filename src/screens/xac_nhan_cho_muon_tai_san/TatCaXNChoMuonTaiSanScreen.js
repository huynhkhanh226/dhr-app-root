...
class TatCaXNChoMuonTaiSanScreen extends Component {
    constructor(props) {
        super(props);
    ...
    _makeRemoteRequest = (cb) => {
        ...
        this.props.xncmtsAction.getListAllBorrow(this.dataFilter, (error, data) => {
    ...
    render() {
        ...
        const {getListAllBorrow} = this.props;
        const getList = getListAllBorrow && getListAllBorrow.rows ? getListAllBorrow.rows : [];
        return (
...
export default connect(state => ({
        getListAllBorrow: state.xncmts.getListAllBorrow
    }), (dispatch) => ({
        navigationActions: bindActionCreators(navigationActions, dispatch),
        xncmtsAction: bindActionCreators(xncmtsAction, dispatch),
    })
)(TatCaXNChoMuonTaiSanScreen);
