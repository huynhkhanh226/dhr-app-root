...
class DaXacNhanChoMuonTaiSanScreen extends Component {
    ...
    _makeRemoteRequest = (cb) => {
        ...
        this.props.xncmtsAction.getListConfirmBorrow(this.dataFilter, (error, data) => {
    ...
    render() {
        ...
        const {getListConfirmBorrow} = this.props;
        const getList = getListConfirmBorrow && getListConfirmBorrow.rows ? getListConfirmBorrow.rows : [];
        return (
...
export default connect(state => ({
        getListConfirmBorrow: state.xncmts.getListConfirmBorrow
    }), (dispatch) => ({
        navigationActions: bindActionCreators(navigationActions, dispatch),
        xncmtsAction: bindActionCreators(xncmtsAction, dispatch),
    })
)(DaXacNhanChoMuonTaiSanScreen);
