...
class DanhSachXNChoMuonTSComponent extends Component {
    constructor(props) {
        super(props);
        this.state = ({
            isChecked: true,
    ...
    render() {
        ...
        const isChecked = value && value.KindVoucherID && parseInt(value.KindVoucherID) ===2 ? 1 : 0;
        return (
            <View style={{
                borderBottomWidth: 1,
                ...
                >
                    <View style={{height: '100%', width: !!isChecked ? '90%' : '100%'}}>
                        <View style={styles.componentViewContent}>
                            <Text style={styles.componentTextContent}>{Config.lang("PM_So_phieu")}</Text>
...
export default DanhSachXNChoMuonTSComponent;
