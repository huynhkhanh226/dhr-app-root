...
class TatCaTraHangScreen extends Component {
    constructor(props) {
        super(props);
    ...
    _makeRemoteRequest = (cb) => {
        ...
        this.props.xnycthAction.getListAllRT(this.dataFilter, (error, data) => {
    ...
    render() {
        ...
        const {getListAllWH} = this.props;
        const getList = getListAllWH && getListAllWH.rows ? getListAllWH.rows : [];
        return (
...
export default connect(state => ({
    getListAllWH: state.xnycth.getListAllRT
    }), (dispatch) => ({
