...
class ChoXacNhanTraHangScreen extends Component {
    constructor(props) {
        super(props);
    ...
    _makeRemoteRequest = (cb) => {
        ...
        this.props.xnycthAction.getListWaitingRT(this.dataFilter, (error, data) => {
    ...
    render() {
        ...
        const {getListWaitingRT} = this.props;
        const getList = getListWaitingRT && getListWaitingRT.rows ? getListWaitingRT.rows : [];
...
export default connect(state => ({
        getListWaitingRT: state.xnycth.getListWaitingRT
    }), (dispatch) => ({
        navigationActions: bindActionCreators(navigationActions, dispatch),
        xnycthAction: bindActionCreators(xnycthAction, dispatch),
    })
)(ChoXacNhanTraHangScreen);
