...
class DanhSachBaoHong extends Component {
    constructor(props) {
        super(props);
        this.state = ({
            isSubmit: false,
            ...
            <View style={styles.componentContainer}>
                ...
                >
                    <View style={{height: '100%', width: '100%'}}>
                        ...
                        <View style={styles.componentViewContent}>
                            <Text
                                style={styles.componentTextContent}>{Config.lang("PM_Nguoi_bao_hong")}</Text>
                            <View style={styles.viewDashContent}>
                            </View>
                        ...
                        <View style={styles.componentViewContent}>
                            <Text
                                style={styles.componentTextContent}>{Config.lang("PM_Ngay_bao_hong")}</Text>
                            <View style={styles.viewDashContent}>
                            </View>
                            <Text style={styles.componentTextContentRight} numberOfLines={1}>
...
class DanhSachPhieuBaoHongScreen extends Component {
    constructor(props) {
        super(props);
    ...
    onLink = (data) => {
        this.props.navigationActions.changeScreen('ChiTietPhieuBaoHongTabScreen',{VoucherID:data.VoucherID, reload: this.onReLoad});
    };
    ...
    onReLoad = () => {
        ...
        this.props.baohongAction.getListBroken(params, (error, data) => {
            if (error) {
    ...
    _makeRemoteRequest = (cb) => {
        ...
        this.props.baohongAction.getListBroken(this.dataFilter, (error, data) => {
...
export default connect(state => ({
        getListBroken: state.baohong.getListBroken,
    }),
    (dispatch) => ({
        baohongAction: bindActionCreators(baohongAction, dispatch),
        navigationActions: bindActionCreators(navigationActions, dispatch),
    })
)(DanhSachPhieuBaoHongScreen);
