...
class DanhSachDinhKemPBHScreen extends Component {
    constructor(props) {
        super(props);
        this.state = ({
        });
    ...
    render() {
        ...
        const dataAttach = getDetailBroken && getDetailBroken.attachment && getDetailBroken.attachment.length>0 ? getDetailBroken.attachment : [];
        return (
