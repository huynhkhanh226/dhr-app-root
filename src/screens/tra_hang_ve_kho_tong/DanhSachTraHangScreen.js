    ...
    render() {
        ...
        return (
            <View style={styles.componentContainer}>
                ...
                >
                {/*<View style={styles.componentViewContainer}>*/}
                    <View style={{height: '100%', width: '100%'}}>
                        <View style={styles.componentViewContent}>
                            <Text
                                style={styles.componentTextContent}>{Config.lang("PM_Nguyen_nhan")}</Text>
                        ...
                        <View style={styles.componentViewContent}>
                            <Text
                                style={styles.componentTextContent}>{Config.lang("PM_Kho_nhap")}</Text>
                            <View style={styles.viewDashContent}>
                            </View>
                        ...
                        <View style={styles.componentViewContent}>
                            ...
                            <Text style={styles.componentTextContentRight} numberOfLines={1}>
                                {value && value.MDIVoucherDate ? moment(value.MDIVoucherDate).format('DD/MM/YYYY') : null}
                            </Text>
                        </View>
                        <View style={styles.componentViewContent}>
                            <Text
...
class DanhSachTraHangScreen extends Component {
    constructor(props) {
        super(props);
    ...
    onLink = (data) => {
        this.props.navigationActions.changeScreen('ChiTietTraHangVeKhoTabScreen',{MDIVoucherID:data.MDIVoucherID, reload: this.onReLoad});
    };
    ...
    onReLoad = () => {
        ...
        this.props.thvktAction.getListMDIVoucher(params, (error, data) => {
            if (error) {
    ...
    _makeRemoteRequest = (cb) => {
        ...
        this.props.thvktAction.getListMDIVoucher(this.dataFilter, (error, data) => {
    ...
    render() {
        ...
        const {getListMDIVoucher} = this.props;
        return (
            <View style={styles.container}>
                ...
                <CListView
                    ref="CListView"
                    data={getListMDIVoucher && getListMDIVoucher.rows ? getListMDIVoucher.rows : dataDSXVT}
                    extraData={getListMDIVoucher && getListMDIVoucher.rows ? getListMDIVoucher.rows : dataDSXVT}
                    keyExtractor={(item) => item.MDIVoucherID}
...
export default connect(state => ({
        getListMDIVoucher: state.thvkt.getListMDIVoucher,
    }),
    (dispatch) => ({
        thvktAction: bindActionCreators(thvktAction, dispatch),
        navigationActions: bindActionCreators(navigationActions, dispatch),
    })
)(DanhSachTraHangScreen);
