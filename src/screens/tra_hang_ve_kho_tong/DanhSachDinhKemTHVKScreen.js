...
class DanhSachDinhKemTHVKScreen extends Component {
    constructor(props) {
        super(props);
        this.state = ({
        });
    ...
    render() {
        ...
        const dataAttach = getDetailMDIVoucher && getDetailMDIVoucher.attachment ? getDetailMDIVoucher.attachment : [];
        return (
