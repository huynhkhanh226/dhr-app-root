...
class ChoXacNhanDeXuatScreen extends Component {
    constructor(props) {
        super(props);
    ...
    _makeRemoteRequest = (cb) => {
        ...
        this.props.xndxvtAction.getListWaitingProposal(this.dataFilter, (error, data) => {
    ...
    render() {
        ...
        const {getListWaitingProposal} = this.props;
        const getList = getListWaitingProposal && getListWaitingProposal.rows ? getListWaitingProposal.rows : [];
...
export default connect(state => ({
        getListWaitingProposal: state.xndxvt.getListWaitingProposal
    }), (dispatch) => ({
        navigationActions: bindActionCreators(navigationActions, dispatch),
        xndxvtAction: bindActionCreators(xndxvtAction, dispatch),
    })
)(ChoXacNhanDeXuatScreen);
