...
class DaXacNhanDeXuatScreen extends Component {
    ...
    _makeRemoteRequest = (cb) => {
        ...
        this.props.xndxvtAction.getListConfirmProposal(this.dataFilter, (error, data) => {
    ...
    render() {
        ...
        const {getListConfirmProposal} = this.props;
        const getList = getListConfirmProposal && getListConfirmProposal.rows ? getListConfirmProposal.rows : [];
        return (
...
export default connect(state => ({
        getListConfirmProposal: state.xndxvt.getListConfirmProposal
    }), (dispatch) => ({
        navigationActions: bindActionCreators(navigationActions, dispatch),
        xndxvtAction: bindActionCreators(xndxvtAction, dispatch),
    })
)(DaXacNhanDeXuatScreen);
