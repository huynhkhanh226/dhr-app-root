...
class DanhSachDinhKemDXScreen extends Component {
    constructor(props) {
        super(props);
        this.state = ({
            isSubmit: false,
    ...
    render() {
        ...
        const attachmentConfirm = getDetailConfirmProposal && getDetailConfirmProposal.AttachmentConfirm ? getDetailConfirmProposal.AttachmentConfirm : [];
        const attachmentVoucher = getDetailConfirmProposal && getDetailConfirmProposal.AttachmentVoucher ? getDetailConfirmProposal.AttachmentVoucher : [];
        return (
