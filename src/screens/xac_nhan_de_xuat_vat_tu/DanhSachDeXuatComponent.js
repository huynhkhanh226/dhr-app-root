...
class DanhSachDeXuatComponent extends Component {
    constructor(props) {
        super(props);
        this.state = ({
            isChecked: true,
    ...
    render() {
        let {value,isStatus} = this.props;
        const isChecked = value && value.IsConfirm ? value.IsConfirm : 0;
        return (
            <View style={{
                borderBottomWidth: 1,
                ...
                >
                    <View style={{height: '100%', width: !!isChecked ? '90%' : '100%'}}>
                        ...
                        {isStatus && <View style={styles.componentViewContent}>
                            <Text
...
export default DanhSachDeXuatComponent;
